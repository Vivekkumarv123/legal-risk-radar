...
export async function POST(req) {
  try {
    ...
    // Formats and generates responses suited for real-time speech.
    // Enforces strict response length and layout criteria for low-latency text-to-speech rendering,
    // translating legal analysis into highly natural regional language outputs.
    const prompt = `
